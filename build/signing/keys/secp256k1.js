...
class Secp256k1 {
  constructor(_key, pk) {
    this._key = _key;
    this.ownerLength =
      constants_1.SIG_CONFIG[constants_1.SignatureConfig.ETHERIUM].pubLength;
    this.signatureLength =
      constants_1.SIG_CONFIG[constants_1.SignatureConfig.ETHERIUM].sigLength;
  ...
  static async verify(pk, message, signature) {
    ...
    let verified = false;
    try {
      verified = secp256k1_1.default.ecdsaVerify(
        signature,
        keccak256_1.default(message),
        p,
      );
