...
class DataItem {
    ...
    getSignature() {
        return base64url_1.default.encode(this.getRawSignature(), "hex");
    }
    getRawOwner() {
    ...
    toJSON(id) {
        return {
            id: id,
            signature: base64url_1.default.encode(this.getSignature(), "hex"),
            owner: base64url_1.default.encode(this.getOwner().toString(), "hex"),
            target: base64url_1.default.encode(this.getTarget().toString(), "hex"),
            tags: base64url_1.default.encode(this.getTags().toString(), "hex"),
            data: base64url_1.default.encode(this.getData().toString(), "hex")
        };
    }
    /**
