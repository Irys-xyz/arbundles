...
class DataItem {
    ...
    get id() {
        return base64url_1.default.encode(this._id, "hex");
    }
    set id(id) {
        this._id = buffer_1.Buffer.from(base64url_1.default.decode(id, "hex"), "hex");
    }
    get rawId() {
        return this._id;
    }
    ...
    get owner() {
        return base64url_1.default.encode(buffer_1.Buffer.from(this.rawOwner), "hex");
    }
    getAddress() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return base64url_1.default.encode(buffer_1.Buffer.from(yield arweave_1.default.crypto.hash(this.rawOwner, "SHA-256")), "hex");
        });
    }
    get rawTarget() {
    ...
    get data() {
        ...
        const numberOfTagBytes = utils_1.byteArrayToLong(numberOfTagBytesArray);
        const dataStart = tagsStart + 16 + numberOfTagBytes;
        return base64url_1.default.encode(this.binary.slice(dataStart, this.binary.length), "hex");
    }
    /**
     * UNSAFE!!
    ...
    sign(jwk) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this._id = yield ar_data_bundle_1.sign(this, jwk);
            return this.rawId;
        });
    }
    isSigned() {
