...
describe.only("getSignatureAndId", () => {
    describe("given we have a dataItem", () => {
        it("should return the signature and id", async () => {
            ...
            expect(signature.toString("hex")).toEqual("e8565eaa672daa07a6526aa807acefd8ed36aceac3ae8e1dc1f3ab26f05af14b0342f65b6aca051fa18a373031d4f67f2ec14680caa3cbdd3cfe0aef149e68f91c")
