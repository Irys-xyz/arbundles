...
async function createData(data, signer, opts) {
  ...
  const _target = (opts === null || opts === void 0 ? void 0 : opts.target)
    ? base64url_1.default.toBuffer(opts.target)
    : null;
  const _anchor = (opts === null || opts === void 0 ? void 0 : opts.anchor)
    ? Buffer.from(opts.anchor)
    : null;
  const _tags =
    ((_b =
      (_a = opts === null || opts === void 0 ? void 0 : opts.tags) === null ||
      _a === void 0
        ? void 0
  ...
  // TODO: Finish this
  stream.write(
    utils_1.longTo8ByteArray(
      (_d =
        (_c = opts === null || opts === void 0 ? void 0 : opts.tags) === null ||
        _c === void 0
          ? void 0
  ...
  const bytesCount = utils_1.longTo8ByteArray(
    (_e = _tags === null || _tags === void 0 ? void 0 : _tags.byteLength) !==
      null && _e !== void 0
      ? _e
      : 0,
  );
