import { fileExportForTesting, fileToJson,getAnchor,getTags,signedFileStream, getTarget, getOwner, numberOfItems,getSignature,getHeaderAt,getId, getHeaders } from "file/file";
...
describe("given we have a FileDataItem", () => {
    ...
    beforeEach(async () => {
        fileDataItem = await createData(data, signer);
